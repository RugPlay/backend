...
export class AnalyticsController {
  ...
  async getOhlcData(
    ...
    try {
      ...
      return await this.analyticsService.getOhlcData(query);
    } catch (error) {
  ...
  async getVolumeData(
    ...
    try {
      ...
      return await this.analyticsService.getVolumeData(query);
    } catch (error) {
      throw new HttpException(
  ...
  @Get("markets/:marketId/price-change")
  @ApiOperation({
  ...
  async getPriceChangeData(
    ...
    try {
      ...
      return await this.analyticsService.getPriceChangeData(query);
    } catch (error) {
      throw new HttpException(
  ...
  @Get("markets/:marketId/latest-price")
  @ApiOperation({
  ...
  async getLatestPrice(@Param("marketId") marketId: string): Promise<number | null> {
    try {
      return await this.analyticsService.getLatestPrice(marketId);
    } catch (error) {
      throw new HttpException(
  ...
  @Get("markets/:marketId/24h-stats")
  @ApiOperation({
  ...
  async get24HourStats(@Param("marketId") marketId: string): Promise<{
    ...
    try {
      return await this.analyticsService.get24HourStats(marketId);
    } catch (error) {
      throw new HttpException(
