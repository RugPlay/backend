...
export async function up(db: Kysely<any>): Promise<void> {
  await db.schema
    ...
    .addColumn('taker_user_id', 'varchar', (col) => col.notNull())
    .addColumn('maker_user_id', 'varchar', (col) => col.notNull())
  ...
  await db.schema.createIndex('idx_trades_taker_user_id').on('trades').column('taker_user_id').execute();
  await db.schema.createIndex('idx_trades_maker_user_id').on('trades').column('maker_user_id').execute();
